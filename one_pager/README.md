`XYZ_1pager.exe` is a compiled Matlab app for generating a one-pager summary of the color performance analysis. It needs to run in the command mode with two parameters:
